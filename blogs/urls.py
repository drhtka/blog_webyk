...
from blogs.views import PostsListView, SubscribeListView, TapeListView, UnSubscribeListView, ReadPostTemplView, AddPostView, AddPostCreateView, AddTestView#, SendPost
...
urlpatterns = [
    ...
    url(r'^addpostcreate', AddPostCreateView.as_view(), name='addpostcreate'),
